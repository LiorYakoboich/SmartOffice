  ...
  ({
    ...
    const handleSubmit = async (
      ...
      /*
        ...
        Chrome password manager / autofill can visually
        fill an input without React receiving an onChange
        event immediately.

        Reading FormData directly from the form guarantees
        that the first click uses the values currently
        displayed inside the actual inputs.
      */
      ...
      /*
        Keep React state synchronized with browser
        autofill values as well.
      */
      ...
      try {
        ...
        // AuthStore displays the API error.
      }
    }
        ...
        >
          ...
          >
            ...
            >
              ...
              desks and shared resources
              from one connected Smart
              Office workspace.
            </Typography>
